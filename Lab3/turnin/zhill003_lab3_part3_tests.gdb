...
test "PINA: 0x30 => PORTC: PC7"
setPINA 0x30
continue 2
expectPORTC 0x80
checkResult

test "PINA: 0x32 => PORTC: PC7"
setPINA 0x32
continue 2
expectPORTC 0x80
checkResult

test "PINA: 0x33 => PORTC: PC7"
setPINA 0x33
continue 2
expectPORTC 0x90
checkResult

test "PINA: 0x35 => PORTC: PC7"
setPINA 0x35
continue 2
expectPORTC 0xB8
checkResult

test "PINA: 0x38 => PORTC: PC7"
setPINA 0x38
continue 2
expectPORTC 0xBC
checkResult

test "PINA: 0x3C => PORTC: PC7"
setPINA 0x3C
continue 2
expectPORTC 0xBE
checkResult

test "PINA: 0x3F => PORTC: PC7"
setPINA 0x3F
continue 2
expectPORTC 0xBF
checkResult

test "PINA: 0x7D => PORTC: PC7"
setPINA 0x7D
continue 2
expectPORTC 0x3F
checkResult
